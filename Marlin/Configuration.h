...
#define Y_DRIVER_TYPE  HBS57
#define Z_DRIVER_TYPE  HBS57
#else
...
#if TRONXY_PROJ == PROJ_X5SA500_PRO \
|| TRONXY_PROJ == PROJ_VEHO600 \
|| TRONXY_PROJ == PROJ_X5SA600 \
|| TRONXY_PROJ == PROJ_X5SA500_2E \
|| TRONXY_PROJ == PROJ_VEHO800 \
...
|| TRONXY_PROJ== PROJ_K1M \
|| TRONXY_PROJ == PROJ_X5SA_PRO \
 ...
 */
#if TRONXY_PROJ == PROJ_X5SA //g,B
  #if USE_EXTRUDER == 4
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 197.48 }
  #else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 766.22 }
  #endif
#elif TRONXY_PROJ == PROJ_X5SA /*g*/\
|| TRONXY_PROJ == PROJ_C2 \
|| TRONXY_PROJ == PROJ_X5SA_g \
|| TRONXY_PROJ == PROJ_X5SA_MINI
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 197.48 }
#elif TRONXY_PROJ == PROJ_XY2_PRO
  #if USE_EXTRUDER == 1 //T:TITAN
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 766.22 }
  #elif USE_EXTRUDER == 4 //g:普通挤出机
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.0, 160.0, 800.0, 197.48 }
  #else
  #error STEPS_PER_UNIT not this extruder
  #endif
#elif TRONXY_PROJ == PROJ_X5SA500_PRO \
|| TRONXY_PROJ == PROJ_X5SA500_2E \
|| TRONXY_PROJ == PROJ_XY2_PRO_3E \
|| TRONXY_PROJ == PROJ_X5SA_PRO_3E
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 362.0 }
...
|| TRONXY_PROJ == PROJ_VEHO500_2E \
|| TRONXY_PROJ == PROJ_VEHO800
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.33, 53.33, 266.67, 362.0 } // xy:30齿 * 2mm z:12mm/圈,16细分
#elif TRONXY_PROJ == PROJ_VEHO800_2E
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.33, 53.33, 266.67, 605.0 }
#elif TAOLI_SERIAL
  #ifdef I_DRIVER_TYPE
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 420, 100, 1440} //X Y Z I E 1200->1440
  #else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 420, 1440} //X Y Z E
  #endif
...
#if TAOLI_SERIAL
  #ifdef I_DRIVER_TYPE
  #define DEFAULT_MAX_FEEDRATE          { 150, 150, 30, 80, 8} //X Y Z I E
  #else
  #define DEFAULT_MAX_FEEDRATE          { 150, 150, 30, 8} //X Y Z E
  #endif
#elif TRONXY_PROJ == PROJ_X5SA500_PRO \
|| TRONXY_PROJ == PROJ_VEHO600 \
|| TRONXY_PROJ == PROJ_X5SA600 \
...
|| TRONXY_PROJ == PROJ_VEHO800 \
|| TRONXY_PROJ == PROJ_VEHO800_2E
  #define DEFAULT_MAX_FEEDRATE          { 150, 150, 40, 40 }
#else
...
#if TAOLI_SERIAL
  #ifdef I_DRIVER_TYPE
  #define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 2000, 2000} //X Y Z I E
  #else
  #define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 2000} //X Y Z E
  #endif
#else
...
// #define NOZZLE_TO_PROBE_OFFSET { 40, 20, 0 } //第一版
#define NOZZLE_TO_PROBE_OFFSET { 35.6, -32.12, 0 } //第二版
#elif TRONXY_PROJ== PROJ_K1M
#define NOZZLE_TO_PROBE_OFFSET { -20.8, -33.5, 0 }
...
|| TRONXY_PROJ == PROJ_XY3SE_2E \
|| TRONXY_PROJ == PROJ_D01 \
|| TRONXY_PROJ == PROJ_XY3_PROPB
#define NOZZLE_TO_PROBE_OFFSET { -28.3, 7.5, 0 }
#elif TRONXY_PROJ == PROJ_XY3SE_V2
#define NOZZLE_TO_PROBE_OFFSET { 35.6, -32.12, 0 }
#elif TRONXY_PROJ == PROJ_D01_PLUS
#define NOZZLE_TO_PROBE_OFFSET { 14, 46, 0 }
#else
...
#if /*TRONXY_PROJ== PROJ_K1M ||*/ TRONXY_PROJ == PROJ_X5SA500_PRO \
|| TRONXY_PROJ == PROJ_VEHO600 \
|| TRONXY_PROJ == PROJ_X5SA600 \
|| TRONXY_PROJ == PROJ_X5SA500_2E \
|| TRONXY_PROJ == PROJ_VEHO500 \
...
#if TRONXY_PROJ == PROJ_XY2_PRO \
|| TRONXY_PROJ == PROJ_XY3_PRO \
|| TRONXY_PROJ == PROJ_XY3SE \
|| TRONXY_PROJ == PROJ_XY3SE_2E \
|| TRONXY_PROJ == PROJ_XY2_PRO_2E \
|| TRONXY_PROJ == PROJ_XY3SE_V2 \
|| TRONXY_PROJ == PROJ_D01 \
|| TRONXY_PROJ == PROJ_XY3_PROPB \
|| TRONXY_PROJ == PROJ_XY2_PRO_3E
